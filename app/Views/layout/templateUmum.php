    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="top-bar row gx-0 align-items-center d-none d-lg-flex">
            <div class="col-lg-9 px-5 text-start">
                <small><i class="fa fa-map-marker-alt text-primary me-2"></i>Jl. Panglima Polim No.18, Segala Mider,
                    Tanjung
                    Karang Barat, Bandar Lampung, Lampung 35152</small>
                <small class="ms-3"><i class="fa fa-calendar text-primary me-2"></i>Senin - Jumat</small>
                <small class="ms-3"><i class="fa fa-clock text-primary me-2"></i>07.00 - 16.00 WIB</small>
            </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="display-5 text-primary m-0">E-SARPRAS SMALAN</h1>
            </a>
